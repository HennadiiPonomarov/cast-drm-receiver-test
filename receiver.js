...
const translations = {
  ...
  hu: {
    ...
    subtitleSize: 'Méret', subtitleStyle: 'Stílus',
    small: 'Kicsi', medium: 'Közepes', large: 'Nagy',
    dropShadow: 'Árnyékhatás', dark: 'Sötét', contrast: 'Kontrasztos', light: 'Világos',
  ...
  bg: {
    ...
    subtitleSize: 'Размер', subtitleStyle: 'Стил',
    small: 'Малък', medium: 'Среден', large: 'Голям',
    dropShadow: 'Ефект на сянка', dark: 'Тъмен', contrast: 'Контрастен', light: 'Светъл',
  ...
  ro: {
    ...
    subtitleSize: 'Dimensiune', subtitleStyle: 'Stil',
    small: 'Mic', medium: 'Mediu', large: 'Mare',
    dropShadow: 'Efect de umbră', dark: 'Întunecat', contrast: 'Contrast', light: 'Deschis',
  ...
  az: {
    ...
    subtitleStyling: 'Altyazı görünüşü',
    subtitleSize: 'Ölçü', subtitleStyle: 'Üslub',
    small: 'Kiçik', medium: 'Orta', large: 'Böyük',
    dropShadow: 'Kölgə effekti', dark: 'Tünd', contrast: 'Kontrastlı', light: 'Açıq',
  ...
  sq: {
    ...
    subtitleSize: 'Madhësia', subtitleStyle: 'Stili',
    small: 'I vogël', medium: 'Mesatar', large: 'I madh',
    dropShadow: 'Efekt hijeje', dark: 'I errët', contrast: 'Kontrast', light: 'I çelët',
  ...
  lv: {
    ...
    subtitleStyling: 'Subtitru izskats',
    subtitleSize: 'Izmērs', subtitleStyle: 'Stils',
    small: 'Mazs', medium: 'Vidējs', large: 'Liels',
    dropShadow: 'Ēnas efekts', dark: 'Tumšs', contrast: 'Kontrastains', light: 'Gaišs',
  ...
  et: {
    ...
    subtitleStyling: 'Subtiitrite välimus',
    subtitleSize: 'Suurus', subtitleStyle: 'Stiil',
    small: 'Väike', medium: 'Keskmine', large: 'Suur',
    dropShadow: 'Varjuefekt', dark: 'Tume', contrast: 'Kontrastne', light: 'Hele',
  ...
  el: {
    ...
    subtitleSize: 'Μέγεθος', subtitleStyle: 'Στυλ',
    small: 'Μικρό', medium: 'Μεσαίο', large: 'Μεγάλο',
    dropShadow: 'Εφέ σκιάς', dark: 'Σκούρο', contrast: 'Υψηλή αντίθεση', light: 'Ανοιχτό',
  ...
  lt: {
    ...
    subtitleSize: 'Dydis', subtitleStyle: 'Stilius',
    small: 'Mažas', medium: 'Vidutinis', large: 'Didelis',
    dropShadow: 'Šešėlio efektas', dark: 'Tamsus', contrast: 'Kontrastingas', light: 'Šviesus',
  ...
  sr: {
    ...
    subtitleSize: 'Veličina', subtitleStyle: 'Stil',
    small: 'Mali', medium: 'Srednji', large: 'Veliki',
    dropShadow: 'Efekat senke', dark: 'Tamni', contrast: 'Kontrastni', light: 'Svetli',
  ...
  mk: {
    ...
    subtitleSize: 'Големина', subtitleStyle: 'Стил',
    small: 'Мал', medium: 'Среден', large: 'Голем',
    dropShadow: 'Ефект на сенка', dark: '\u0422\u0435\u043c\u0435\u043d', contrast: 'Контрастен', light: 'Светол',
  ...
  bs: {
    ...
    subtitleSize: 'Veličina', subtitleStyle: 'Stil',
    small: 'Mali', medium: 'Srednji', large: 'Veliki',
    dropShadow: 'Efekat sjene', dark: 'Tamni', contrast: 'Kontrastni', light: 'Svijetli',
    live: 'Uživo', recording: 'Snimak', movie: 'Film',
  },
  sl: {
    ...
    subtitleSize: 'Velikost', subtitleStyle: 'Slog',
    small: 'Majhen', medium: 'Srednji', large: 'Velik',
    dropShadow: 'Učinek sence', dark: 'Temen', contrast: 'Kontrasten', light: 'Svetel',
  ...
  hr: {
    ...
    subtitleSize: 'Veličina', subtitleStyle: 'Stil',
    small: 'Mali', medium: 'Srednji', large: 'Veliki',
    dropShadow: 'Efekt sjene', dark: 'Tamni', contrast: 'Kontrastni', light: 'Svijetli',
